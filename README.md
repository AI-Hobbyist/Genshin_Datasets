...
|  **语音数据集**(完整包)  | 4.7  | 4.7  | 4.6  | 4.6  |
|  **语音数据集**(完整包-国内镜像)  | 4.6  | 4.6  | 4.6  | 4.6  |
...
|   **完整包（国内推荐此线路）**   |       [点我获取](https://dl.ai-hobbyist.org/ms/datasets/aihobbyist/Genshin_Dataset/Genshin4.6_CN.7z)       |       [点我获取](https://dl.ai-hobbyist.org/ms/datasets/aihobbyist/Genshin_Dataset/Genshin4.6_JP.7z)       |       [点我获取](https://dl.ai-hobbyist.org/ms/datasets/aihobbyist/Genshin_Dataset/Genshin4.6_EN.7z)       |                            [点我获取](https://dl.ai-hobbyist.org/ms/datasets/aihobbyist/Genshin_Dataset/Genshin4.6_KR.7z)                            |
